...
a=read.csv("/Volumes/SeaGate/IUU_GRW/data/gaps_2018_v20190618.csv") %>% filter(gap_hours<250)%>% filter(type=="AIS.1"|type=="AIS.2"|type=="AIS.3") %>% filter(distance_from_shore_m>8000&next_distance_from_shore_m>8000) 
